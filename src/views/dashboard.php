...
<div class="sidebar" id="sidebar">
    ...
    <select id="tzSelect" onchange="onTzChange()" class="w-full border border-gray-300 rounded px-2 py-1 text-sm mb-2 focus:outline-none focus:ring-2 focus:ring-emerald-500">
